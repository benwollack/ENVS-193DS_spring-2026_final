...
I found a moderate, positive correlation (Spearman's $\rho$ = 0.415) between the daily high temperature and the distance I walked that day. The high temperature accounted for 11.62% of the variation in distance walked (linear regression, F(1,30) = 5.075, $R^2$ = 0.1162, p = 0.03174, $\alpha$ = 0.05), and with every one degree increase in temperature, the model predicted that I would walk an additional 0.3918 $\pm$ 0.1739 (SE) km. 
