...
Temperature is a continuous variable. My app for measuring temperature was only accurate to the nearest degree, which is why all data took on integer values. However, a prediction for a temperature of 17.5$^\circ$ C makes sense (as opposed to a prediction for 17.5 elephants). 
...
I found a moderate, positive correlation (Spearman's $\rho$ = 0.415) between the daily high temperature and the distance I walked that day. The high temperature accounted for 11.62% of the variation in distance walked (linear regression, F(1,30) = 5.075, $R^2$ = 0.1162, p = 0.03174, $\alpha$ = 0.05), and with every one degree increase in temperature, the model predicted that I would walk an additional 0.3918 $\pm 2$ 0.1739 (SE) km. 
